...
class Help(commands.Cog, name="Help"):
    ...
    async def help(self, ctx):
        ...
        reactions = ["🛠️", "💰", "🎟️", "🛒", "📖"]
        reactionsCogs = ["🛠️ Admin Commands", "💰 Economy", "🎟️ Raffle System", "🛒 Shop", "📖 Profile System"]
        ...
        hidden_cogs = ['Help', 'Functions', 'Example Cogs', 'Jishaku', 'levelingSystem', 'setCurrency', 'Leveling']
